package HoneyDoPetSitting::Controller::Books;
use Moose;
...
HoneyDoPetSitting::Controller::Books - Catalyst Controller
...
sub index :Path :Args(0) {
    ...
    $c->response->body('Matched HoneyDoPetSitting::Controller::Books in Books.');
}

=head2 base

Can place common login to start chained dispatch here
...
sub object :Chained('base') :PathPart('id') :CaptureArgs(1) {
    ...
    #make sure the lookup was successfull. You would probably 
...
sub list_recent :Chained('base') :PathPart('list_recent') :Args(1) {
    ...
    # retrieve books crested within the last $min number of minutes
...
sub list_recent_tcp :Chained('base') :PathPart('list_recent_tcp') :Args(1) {
    ...
    # Retrieve all of the book records as book model objects and store in the 
    # stash where they can be accssed by the TT template, but only 
