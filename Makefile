# This Makefile is for the HoneyDoPetSitting extension to perl.
#
...
#     AUTHOR => [q[Jack Lupton]]
#     BUILD_REQUIRES => { Test::More=>q[0.88], ExtUtils::MakeMaker=>q[6.36] }
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[HoneyDoPetSitting]
#     EXE_FILES => [q[script/honeydopetsitting_cgi.pl], q[script/honeydopetsitting_create.pl], q[script/honeydopetsitting_fastcgi.pl], q[script/honeydopetsitting_server.pl], q[script/honeydopetsitting_test.pl]]
#     LICENSE => q[perl]
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = HoneyDoPetSitting
NAME_SYM = HoneyDoPetSitting
VERSION = 0.01
...
MAKE = make
FULLEXT = HoneyDoPetSitting
BASEEXT = HoneyDoPetSitting
PARENT_NAME = 
DLBASE = $(BASEEXT)
VERSION_FROM = lib/HoneyDoPetSitting.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
O_FILES  = 
H_FILES  = 
MAN1PODS = script/honeydopetsitting_cgi.pl \
...
DISTNAME = HoneyDoPetSitting
DISTVNAME = HoneyDoPetSitting-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=1 --perm_rw=$(PERM_RW) \
	  ...
	  script/honeydopetsitting_fastcgi.pl $(INST_MAN1DIR)/honeydopetsitting_fastcgi.pl.$(MAN1EXT) \
...
EXE_FILES = script/honeydopetsitting_cgi.pl script/honeydopetsitting_create.pl script/honeydopetsitting_fastcgi.pl script/honeydopetsitting_server.pl script/honeydopetsitting_test.pl

pure_all :: $(INST_SCRIPT)/honeydopetsitting_test.pl $(INST_SCRIPT)/honeydopetsitting_server.pl $(INST_SCRIPT)/honeydopetsitting_fastcgi.pl $(INST_SCRIPT)/honeydopetsitting_create.pl $(INST_SCRIPT)/honeydopetsitting_cgi.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/honeydopetsitting_test.pl $(INST_SCRIPT)/honeydopetsitting_server.pl \
	  $(INST_SCRIPT)/honeydopetsitting_fastcgi.pl $(INST_SCRIPT)/honeydopetsitting_create.pl \
	  $(INST_SCRIPT)/honeydopetsitting_cgi.pl 

$(INST_SCRIPT)/honeydopetsitting_test.pl : script/honeydopetsitting_test.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/honeydopetsitting_test.pl
	$(CP) script/honeydopetsitting_test.pl $(INST_SCRIPT)/honeydopetsitting_test.pl
	$(FIXIN) $(INST_SCRIPT)/honeydopetsitting_test.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/honeydopetsitting_test.pl

$(INST_SCRIPT)/honeydopetsitting_server.pl : script/honeydopetsitting_server.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/honeydopetsitting_server.pl
	$(CP) script/honeydopetsitting_server.pl $(INST_SCRIPT)/honeydopetsitting_server.pl
	$(FIXIN) $(INST_SCRIPT)/honeydopetsitting_server.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/honeydopetsitting_server.pl

$(INST_SCRIPT)/honeydopetsitting_fastcgi.pl : script/honeydopetsitting_fastcgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/honeydopetsitting_fastcgi.pl
	$(CP) script/honeydopetsitting_fastcgi.pl $(INST_SCRIPT)/honeydopetsitting_fastcgi.pl
	$(FIXIN) $(INST_SCRIPT)/honeydopetsitting_fastcgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/honeydopetsitting_fastcgi.pl

$(INST_SCRIPT)/honeydopetsitting_create.pl : script/honeydopetsitting_create.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/honeydopetsitting_create.pl
	$(CP) script/honeydopetsitting_create.pl $(INST_SCRIPT)/honeydopetsitting_create.pl
	$(FIXIN) $(INST_SCRIPT)/honeydopetsitting_create.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/honeydopetsitting_create.pl

$(INST_SCRIPT)/honeydopetsitting_cgi.pl : script/honeydopetsitting_cgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/honeydopetsitting_cgi.pl
	$(CP) script/honeydopetsitting_cgi.pl $(INST_SCRIPT)/honeydopetsitting_cgi.pl
	$(FIXIN) $(INST_SCRIPT)/honeydopetsitting_cgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/honeydopetsitting_cgi.pl
