...
#         FILE: live_app01.t
#
#  DESCRIPTION: From the testing chapter of the Catalyst tutorial
#
#        FILES: ---
#         BUGS: ---
#        NOTES: ---
...
# ORGANIZATION: 
#      VERSION: 1.0
#      CREATED: 01/17/2014 09:10:54 PM
#     REVISION: ---
#===============================================================================
...
#
BEGIN { use_ok("Test::WWW::Mechanize::Catalyst" => "HoneyDoPetSitting")}
...
# tests)
# Note that in test scripts you sen deverything to 'http://localhost'
# $_->get_ok("http://localhost/", "Check redirect of base URL") for $ua1,
# $ua2;
# Use title_is() to check the contenst of the <title>...</title> tags
...
# Could make user like user1 above, but use the form to show another way
$ua2->submit_form(
    fields => {
        username => 'test02',
        password => 'mypass',
